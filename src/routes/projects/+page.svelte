...
<svelte:head>
	<title>Projects | Angel's folio</title>
	<meta
		name="description"
		content="A small collection of some projects I've built, mostly as a hobby"
	>
</svelte:head>
...
<div class="p-8">
	...
	<div class="mb-8">
		<h2 class="flex gap-3 text-xl font-normal mb-2">
			...
			<a
				href="https://github.com/AngelCMHxD/PeekM2"
	...
	<div class="mb-8">
		<h2 class="flex gap-3 text-xl font-normal mb-2">
			...
			<a
				href="https://github.com/AngelCMHxD/chess-now"
				class="hover:underline"
			>
				(Repo)
			</a>
	...
	<div class="mb-8">
		<h2 class="flex gap-3 text-xl font-normal mb-2">
			...
			<a
				href="https://github.com/AngelCMHxD/easy-legendary"
				class="hover:underline"
			>
				(Repo)
			</a>
	...
	<button type="button" tabindex="-1" class="w-fit" onclick={() => goto('/')}>
		{"$"}
		cd ..
	</button>
